...
export const article: NewsEditorial = {
  ...
  sections: [
    ...
    },
    {
      ...
      transition: 'A capacity argument is only worth making if capacity is what actually holds smaller firms back, and the adoption series has recently started to point the other way.',
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        { text: 'Proximity remains an advantage, and it does more for the second release than the first. A firm of twenty can look at what a release actually did, take the expand, adjust, hold or stop decision on that evidence, and act on it the same week. Large organisations struggle at precisely that point. Short decision lines pay once there is something to decide on, and producing that something is a capacity problem no meeting can solve by meeting harder.' },
      ],
    },
  ],
};

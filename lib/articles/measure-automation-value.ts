  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        { text: 'One moderator transfers between the two studies. Assistance pays most where the worker lacks context the model can supply, and pays least, or costs time, where the worker already holds more context than the model can reconstruct. METR published a second reading of its own experiment in February 2026, reporting a smaller and statistically inconclusive slowdown among newly recruited developers. That is the direction the moderator predicts.', sources: [metrStudy, metrRerun] },
    ...
    },
    {
      ...
      paragraphs: [
        ...
        { text: 'The concession the method has to make is about pricing, and about how confidence is recorded. A benefit may sit in the ledger with a named mechanism, a named manager and a stated result that would disprove it, at low confidence and with no pound attached. The programme in the opening arithmetic reported as cash a quantity it had never observed. That is the defect, and it survives whatever the true benefit turns out to be.' },
      ],
    },
    {

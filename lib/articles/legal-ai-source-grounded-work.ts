  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        { text: 'None of this yet supports a productivity claim. The compressions that suppliers report come from bounded contract tasks inside their own implementations, and no figure quoted here was produced by measuring a firm running the design described above. The evaluation set is the mechanism through which a firm would establish such a claim for itself.' },
        { text: 'Fluency and a long reference list are evidence of neither accuracy nor care. A legal AI service holds a bounded place in practice on three conditions: the evidence behind each proposition stays visible at the point of review, responsibility for the accepted claim stays attributable to a named professional, and weak support becomes easier to find than it was before the service arrived.' },
      ],
    },
  ],
};

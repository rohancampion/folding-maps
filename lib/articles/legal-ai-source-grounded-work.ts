...
export const article: NewsEditorial = {
  ...
  standfirst: 'English courts have referred lawyers to their regulators over citations that did not exist. Proposition-level review is the control that answers that failure, and a source-grounded research tool does not supply it alone.',
  thesis: 'Legal AI becomes usable at the point where every material proposition carries the relevant authority, jurisdiction and effective date, and an identified professional accepts or rejects it with the supporting passage in view.',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        { text: 'A proposition either carries its route back to authority or it stays a suggestion. The reviewer should be able to select any material claim in a draft, open the passage behind it, see the issuing court, the date and the jurisdiction, read whatever cuts against it, and record acceptance or rejection under their identity. A claim that cannot be opened that way has no business inside advice going out under a practising certificate.' },
        { text: 'Scope the first release to one matter type, one approved source hierarchy and an identified group of professional users. Give it stop conditions that need no meeting to invoke: an identity that cannot be confirmed, a source that cannot be reached, a validity check that fails, a regression against the evaluation set. Expansion should turn on evidence from supervised live use about proposition support, material omission, reviewer effort and confidentiality, and on nothing softer than that.' },
        { text: 'None of this yet supports a productivity claim. The compressions that suppliers report come from bounded contract tasks inside supplier implementations, and no figure quoted here was produced by measuring a firm running the design described above. The evaluation set is the mechanism through which a firm would establish such a claim for itself.' },
        { text: 'Fluency and a long reference list are evidence of neither accuracy nor care. A legal AI service holds a bounded place in practice on three conditions: the evidence behind each proposition stays visible at the point of review, responsibility for the accepted claim stays attributable to an identified professional, and weak support becomes easier to find than it was before the service arrived.' },
      ],
    },
  ],
};

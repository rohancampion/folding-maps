  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        { text: 'None of this makes the technology page wrong. It reports something real, which is that colleagues are willing to use these tools and have found useful applications. The management task is to take one of those applications, put it inside the operating record, and let a number the firm already publishes decide whether the next connection gets funded.' },
      ],
    },
  ],
};

...
export const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Expected value', paragraphs: ['The expected value is a shift in staff attention from compiling routine reports to resolving exceptions. Any pilot should measure alert precision, response time, reporting effort and the completeness of the evidence attached to each closure.', 'These are hypotheses and design targets. No client result has been measured against them yet.'] },
    ],
    barTitle: 'Exception quality depends on context',
  ...
  },
  {
    ...
    barTitle: 'Automation prepares; a professional accepts',
...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      { heading: 'Measure the operating result', paragraphs: ['Measure cycle time, quality, rework and exception demand before and after the change. Track adoption only as a leading indicator. The outcome to report is improved workflow performance. A licensed-user count says nothing about it.', 'This discipline also improves investment choices. A modest model connected to reliable data and a clear process can outperform a more capable model sitting beside the workflow.'] },
    ],
  ...
  },
  {
    ...
    takeaways: ['Cheaper inference permits broader testing. Governance should hold where it is.', 'Total workflow cost includes review, errors, latency and infrastructure.', 'Prompts, evaluations and business rules should remain portable.'],
    sections: [
  ...
  },
  {
    ...
    takeaways: ['Time released is capacity. Converting it to cash takes a further decision.', 'Quality and demand effects may matter more than labour savings.', 'Each benefit needs one operational manager and an agreed route to cash or capacity.'],
    sections: [
    ...
    exhibit: { title: 'Released capacity is not the same as realised cash', subtitle: 'Modelled bridge from gross time saving to evidenced value.', bars: [{ label: 'Gross task time released', value: 100, display: '100 hours' }, { label: 'After adoption and exceptions', value: 72, display: '72 hours' }, { label: 'Redeployed to measured work', value: 48, display: '48 hours' }, { label: 'Converted to cash impact', value: 20, display: '20 hours equivalent' }], note: 'Source: Quiet Gears value bridge. The shape demonstrates measurement logic. It forecasts nothing.' },

...
const openAiIronclad = { label: 'OpenAI, Ironclad customer story (vendor material)', href: 'https://openai.com/index/ironclad/' };
const googleRadisson = { label: 'Google Cloud, Radisson Hotel Group customer story (vendor material)', href: 'https://cloud.google.com/customers/radisson' };
const googleTaua = { label: 'Google Cloud, Tauá Resorts customer story (vendor material)', href: 'https://cloud.google.com/customers/taua-resorts' };
const microsoftSno = { label: 'Microsoft, SNÖ Hotels customer story (vendor material)', href: 'https://www.microsoft.com/en/customers/story/25861-sno-hotels-dynamics-365-business-central' };
const openAiBooking = { label: 'OpenAI, Booking.com customer story (vendor material)', href: 'https://openai.com/index/booking-com/' };

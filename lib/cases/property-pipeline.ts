...
export const study: CaseStudy = {
  ...
  phases: [
    ...
    { label: 'Progress', detail: 'Log every open question against a named holder and a date.' },
...
export const editorial: CaseEditorial = {
  ...
  thesis: 'Rebuilding a property pipeline pays only where a transaction can be tested against the evidence its recorded stage implies, and this engagement is built to test one proposition: that the delay everybody attributes to third parties begins with a question which entered the file weeks earlier and was assigned to nobody.',
  sceneLabel: 'Six weeks in',
  openingTitle: 'Six weeks of progress rest on an approval nobody can produce',
  openingParagraphs: [
    'Six weeks into a transaction the file looks healthy. Calls have been logged, three drafts of the report have gone back and forth, and the tracker puts the deal comfortably in review. At the Thursday pipeline meeting somebody asks to see the approval that let it leave the evidence stage. Nobody can produce one. The hour that follows is spent establishing whether the approval was given and never written down, or was never given at all.',
    'That hour is the visible part. The invisible part started in week two, when a question about a restriction on the title arrived in an email addressed to two people, was read by both and taken up by neither. The tracker recorded none of it, because the tracker records stages and the stage had already been set.',
  ...
  centralQuestion: 'The whole design rests on whether one transaction record can show a stage testable against the documents held, together with a list of open questions each of which has somebody’s name against it.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        { text: 'Better document management would close only part of this. One of the five categories is a question raised in writing and picked up by nobody, which no storage system detects at all. A document store answers where a file is. It does not answer whether the set is complete for the stage being claimed, or whose week the next step belongs in. Those are the two questions a pipeline meeting asks, and both are currently answered from memory.' },
      ],
    },
    {

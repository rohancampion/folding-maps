    ...
    sections: [
      {
        ...
        purpose: 'Follow one customer update through the fragmented workflow.',
        paragraphs: [
      ...
      },
      {
        ...
        purpose: 'Show how missing state and ownership changed the diagnosis.',
        paragraphs: [
          { text: 'Following the enquiry exposed a sequence of missing links. Customer identity alone could not answer the request; the team also needed the current project state. A status without a next action and owner still left coordination to memory. Management visibility, in turn, had to come from the same record used in daily work.' },
          { text: 'Discovery workshops ranked shared customer context as critical, with next-action ownership and management visibility close behind. Automated drafting came later. The normalised workshop scores report the resulting priority order. They are measured outputs from the synthesis, expressed as ordinal design judgements with no claim about performance.' },
      ...
      },
      {
        ...
        purpose: 'Design one trusted record around the enquiry journey.',
        paragraphs: [
      ...
      },
      {
        ...
        purpose: 'Define the conditions under which colleagues can rely on the record.',
        paragraphs: [
      ...
      },
      {
        ...
        purpose: 'Set the evidence threshold for releasing the shared record.',
        paragraphs: [
          { text: 'Discovery and architecture have produced a target record, state model, ownership rule and release boundary. Evidence about coordination time, overdue actions and customer-response effort will emerge only through live use, so the case makes no improvement claim.' },
    ...
    sections: [
      {
        ...
        purpose: 'Reconstruct what the 02:13 threshold crossing actually means.',
        paragraphs: [
      ...
      },
      {
        ...
        transition: 'Severity now depends on assembled context. The system must preserve that context, route the case to an owner and record the eventual resolution.',
      ...
      },
      {
        ...
        purpose: 'Set the release boundary for overnight operational use.',
        paragraphs: [
    ...
    sections: [
      {
        ...
        purpose: 'Trace the missing approval back through the Friday review.',
        paragraphs: [
          { text: 'The transaction contains plenty of activity but cannot support the statement that it is ready to advance. The missing approval exposes a deeper divergence among stage, evidence and decision ownership; document management accounts for only part of the failure.' },
      ...
      },
      {
        ...
        purpose: 'Keep the first transaction type narrow enough to evaluate.',
        paragraphs: [
    ...
    sections: [
      {
        ...
        purpose: 'Follow a referral from first evidence to acceptance decision.',
        paragraphs: [
          ...
          { text: 'A model can summarise the referral; that capability leaves the operating problem unresolved. The engagement must determine whether the whole item can reach an accountable acceptance decision with less reconstruction and intact control integrity. Discovery begins by separating the kinds of work hidden inside intake.' },
        ],
      },
      {
      ...
      },
      {
        ...
        purpose: 'Measure preparation effort without weakening control integrity.',
        paragraphs: [
    ...
    sections: [
      {
        ...
        purpose: 'Place the 07:10 urgent job inside the day’s existing promises.',
        paragraphs: [
      ...
      },
      {
        ...
        purpose: 'Remove infeasible assignments before scoring preferences.',
        paragraphs: [
      ...
      },
      {
        ...
        purpose: 'Use shadow planning and overrides to expose weak assumptions.',
        paragraphs: [

...
export const industryServiceRecommendations: Record<string, IndustryServiceRecommendation[]> = {
  'aerospace-and-defense': [
    { slug: 'ai-readiness', rationale: 'Assess data, security, engineering assurance and programme ownership before introducing AI into controlled work.' },
    { slug: 'private-ai-concierge', rationale: 'Provide cited access to approved technical knowledge within defined security and access boundaries.' },
  ...
  agriculture: [
    { slug: 'ai-for-smes', rationale: 'Prioritise practical improvements that fit seasonal operations, available data and internal capacity.' },
  ...
  chemicals: [
    { slug: 'ai-readiness', rationale: 'Evaluate process data, regulatory constraints and decision rights before selecting priority use cases.' },
    { slug: 'private-ai-concierge', rationale: 'Support secure access to formulations, safety information and technical records with source attribution.' },
  ...
  'consumer-packaged-goods': [
    ...
    { slug: 'perplexity-implementation', rationale: 'Establish cited market, competitor and consumer research methods for commercial teams.' },
  ],
  education: [
    ...
    { slug: 'private-ai-concierge', rationale: 'Give staff controlled access to approved policy, curriculum and operational knowledge.' },
  ...
  'electric-power-and-natural-gas': [
    ...
    { slug: 'private-ai-concierge', rationale: 'Support restricted operational and engineering knowledge with robust identity and evidence controls.' },
  ...
  'energy-and-materials': [
    { slug: 'ai-readiness', rationale: 'Assess data quality, operating risk and delivery capability across sites and value-chain activities.' },
  ...
  'engineering-construction-and-building-materials': [
    ...
    { slug: 'ai-for-smes', rationale: 'Focus investment on practical use cases that fit specialist contractors and regional operators.' },
  ],
  'financial-services': [
    { slug: 'enterprise-ai', rationale: 'Establish shared architecture, assurance and portfolio governance across regulated functions.' },
    { slug: 'private-ai-concierge', rationale: 'Provide controlled access to client, policy and product knowledge with auditable permissions.' },
  ...
  healthcare: [
    { slug: 'ai-readiness', rationale: 'Assess clinical, operational, information-governance and adoption requirements before delivery.' },
    { slug: 'private-ai-concierge', rationale: 'Support secure, cited access to approved policy and professional knowledge.' },
  ...
  infrastructure: [
    ...
    { slug: 'private-ai-concierge', rationale: 'Protect commercially sensitive and security-relevant project knowledge.' },
  ],
  'life-sciences': [
    { slug: 'ai-readiness', rationale: 'Evaluate data provenance, validation, quality systems and accountable ownership before implementation.' },
    { slug: 'private-ai-concierge', rationale: 'Provide controlled access to research, quality and regulatory knowledge with full source visibility.' },
    { slug: 'perplexity-implementation', rationale: 'Create rigorous, cited research workflows with explicit expert verification.' },
  ],
  logistics: [
  ...
  'metals-and-mining': [
    ...
    { slug: 'private-ai-concierge', rationale: 'Securely connect technical procedures, asset history and operating knowledge.' },
  ],
  'oil-and-gas': [
    { slug: 'private-ai-concierge', rationale: 'Provide controlled access to engineering, safety and asset knowledge within strict data boundaries.' },
    { slug: 'agentic-ai', rationale: 'Prepare complex work packs and investigations while retaining formal technical authority.' },
    { slug: 'ai-readiness', rationale: 'Assess process safety, information quality and operational ownership before deployment.' },
  ],
  'packaging-and-paper': [
    ...
    { slug: 'ai-for-smes', rationale: 'Select practical improvements that fit site economics and available delivery capacity.' },
  ],
  'private-capital': [
    { slug: 'perplexity-implementation', rationale: 'Establish cited market, company and sector research workflows for investment teams.' },
    { slug: 'private-ai-concierge', rationale: 'Protect confidential deal and portfolio information while improving knowledge access.' },
  ...
  'public-sector': [
    ...
    { slug: 'private-ai-concierge', rationale: 'Support secure, cited access to policy, case and operational knowledge.' },
  ...
  semiconductors: [
    { slug: 'private-ai-concierge', rationale: 'Protect intellectual property while improving access to engineering and manufacturing knowledge.' },
  ...
  'social-sector': [
    { slug: 'ai-for-smes', rationale: 'Focus limited capacity on mission-linked improvements with proportionate governance.' },
    { slug: 'private-ai-concierge', rationale: 'Provide controlled access to policy and programme knowledge while protecting sensitive information.' },
  ...
  travel: [
    ...
    { slug: 'voice-ai', rationale: 'Support high-volume service calls where availability, structured capture and escalation matter.' },
  ],
};

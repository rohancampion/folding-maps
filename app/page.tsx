...
const services = [
  { n: '01', icon: Compass, title: 'AI strategy', slug: 'ai-strategy', text: 'A practical roadmap from first opportunity to an AI-enabled operation, grounded in your systems, people and commercial priorities.' },
  { n: '02', icon: Workflow, title: 'AI implementation', slug: 'ai-implementation', text: 'Connect capable models to the tools your teams already use, removing handoffs and getting information where it needs to be.' },
  { n: '03', icon: Bot, title: 'Agents and automation', slug: 'agentic-ai', text: 'Purpose-built agents that handle repetitive, multi-step work reliably, with people kept in control where it matters.' },
  { n: '04', icon: Code2, title: 'Modern applications', slug: 'legacy-modernisation', text: 'Specialist internal software, portals and operational tools designed around the way your business really works.' },
  { n: '05', icon: Globe2, title: 'AI assistants', slug: 'ai-chatbot', text: 'Grounded customer and employee assistants that connect approved knowledge to useful action.' },
  { n: '06', icon: Layers3, title: 'Training and adoption', slug: 'chatgpt-training-for-teams', text: 'Role-specific training and ongoing improvement so your team can use new systems with confidence.' },
];
